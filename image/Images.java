...
public class Images {
	...
	static {
		try {
		    ...
		    images.add(toCompatibleImage(ImageIO.read(Main.class.getResource("/image/help.png"))));			// HELP, MAAR NOG GEEN JUIST PLAATJE
	...
	public enum ImageType {
		pulse,cursor,pressstart,colorstrike,background,aanwijzers,kast,gameover,help, screenshot
	}
